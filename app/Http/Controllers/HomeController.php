...
class HomeController extends Controller
{
    ...
    {
        $new_product=DB::table('tbl_category_product')->where('new',1)->get();
    	...
    	return view('pages.home')->with('category',$cate_product)->with('brand',$brand_product)->with('all_product',$all_product)->with('new_product',$new_product) ;
    }
